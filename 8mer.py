...
def get_matches(start_position, end_position, target_positions):
    ...
    for amino_acid_position in range(start_position, end_position - 7):  #8mer
        matching_positions = [pos for pos in range(amino_acid_position, amino_acid_position + 8) if pos in target_positions]
